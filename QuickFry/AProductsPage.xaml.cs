...
public partial class AProductsPage : ContentPage
{
    ProductViewModel ProdVM = new ProductViewModel();
    string searchString;

    public AProductsPage()
	{
		InitializeComponent();
    ...
    private async void GotoProdAddPage(object sender, EventArgs e)
    {
        ...
        await Shell.Current.GoToAsync(nameof(AProdAddPage));
    }
}